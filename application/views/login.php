...
<body class="off-canvas-sidebar", style="background-image: url('<?php echo base_url('assets/img/login.png'); ?>'); background-size: cover; background-repeat: no-repeat; background-position: center;">
  <!-- Extra details for Live View on GitHub Pages -->
            ...
            <form class="form" method="POST" action="<?php echo base_url('Auth/auth') ?>">
              <div class="card card-login card-hidden">
                <div class="card-header card-header-primary text-center">
                  <h4 class="card-title">GYM STRUGGLE</h4>
                </div>
